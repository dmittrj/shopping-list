<?php
    ...
    define('TABLE_COLLABOR_LISTS', "`list_id` INT UNSIGNED NOT NULL AUTO_INCREMENT , `list_title` VARCHAR(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL , `list_version` INT UNSIGNED NOT NULL DEFAULT '0' , `list_status` BOOLEAN NOT NULL DEFAULT TRUE");
